...
#inicio das Funções que no fim serão TASK

def acesso_url():
    
    # URL do endpoint OData
    odata_url = "https://rpeotta.e-clic.net/bi/Documentos"
    ...
    #df_documentos.to_excel('/opt/airflow/logs/relatorio_documentos.xlsx',index=False)
    df_documentos.to_excel(r'/opt/airflow/dados/01. LD e CR/0000 - BASE DE DADOS/relatorio_documentos_airflow.xlsx',index=False)
    #\\wsl.localhost\Ubuntu-22.04\mnt\rede_rpeotta\01. LD e CR\0000 - BASE DE DADOS
...
with DAG(
    'api-eclick-ETL-documentos',
    default_args=default_args,
    description='Dag - ELT do relatorio de documentos do eclick',
